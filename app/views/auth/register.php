...
<div class="auth-page">
  <div class="auth-card glass">
    ...
    <div class="auth-logo">
      <img src="<?= BASE_URL ?>/img/logo-dark.png" alt="StudentLife Hub" style="width:48px;height:48px;border-radius:14px;object-fit:contain;">
    ...
    <form method="POST" action="<?= BASE_URL ?>/auth/register">
      <div class="form-group" style="margin-bottom:14px;">
        ...
        <input type="text" name="name" placeholder="Meline Martin" required>
      </div>
      <div class="form-group" style="margin-bottom:14px;">
        <label>Email</label>
        <input type="email" name="email" placeholder="meline@example.com" required autocomplete="email">
      </div>
      <div class="form-group" style="margin-bottom:14px;">
